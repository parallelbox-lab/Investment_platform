<?php 
    ...
    if(!isset($_SESSION['coupen_agent_id'])){
        header("location:../sign-in");
    }
    
$usr_id = $_SESSION['coupen_agent_id'];

$selectthisuser = mysqli_query($conn,"SELECT * FROM users WHERE id = '$usr_id' and role_id='2' ");
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"><a href="./" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Dashboard </span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-content-copy"></i><span class="hide-menu">Coupon</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="?pg=generate_coupon" class="sidebar-link"><i class="mdi mdi-format-align-left"></i><span class="hide-menu"> Generate Coupon </span></a></li>
                                <li class="sidebar-item"><a href="?pg=view-all-coupon" class="sidebar-link"><i class="mdi mdi-format-align-left"></i><span class="hide-menu"> View all Coupons </span></a></li>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Wallet Balance</span>
                                                <h3 class="font-medium m-b-0">N<?php echo number_format($su['wallets']) ?></h3>
                                            </div>
                                        </div>
                                    </div>
            </div>
