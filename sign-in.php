<?php 
    ...
    if(isset($_REQUEST['email'])){
        ...
        if($check_array && $check_array['role_id'] == "0"){
        ...
        }else if($check_array && $check_array['role_id'] == "2"){
            $message = '<div class="alert alert-danger">User exist! Check details and try again</div>';
                       
            $_SESSION['coupen_agent_id'] = $check_array['id'];
            $_SESSION['surname'] = $check_array['surname'];
            
            header("location:coupon_agent/");
        }else{
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span class="db" ><img src="logo/newlogo.png" alt="logo" style="width:90px"  /></span>
                            ...
                            <form class="form-horizontal m-t-20" id="loginform" method="post">
                                ...
                                <div class="form-group m-b-0 m-t-10">
                                    <div class="col-sm-12 text-center">
                                        Don't have an account? <a href="sign-up" class="text-info m-l-5"><b>Sign Up</b></a>
                                    </div>
                                </div>
                            </form>
                        </div>
